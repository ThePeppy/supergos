...
mkdir -p "$HOME/.config/opencode/supergos"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/supergos/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/supergos/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/supergos/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/supergos.js" "$HOME/.config/opencode/supergos/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/supergos/.opencode/plugin/supergos.js" \
       "$HOME/.config/opencode/plugin/supergos.js"
...
echo "Plugin installed to: $HOME/.config/opencode/supergos/.opencode/plugin/supergos.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/supergos.js"
