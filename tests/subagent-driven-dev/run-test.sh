...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/supergos
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/supergos-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using supergos:subagent-driven-development. The plan is at: $PLAN_PATH"
