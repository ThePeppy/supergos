...
# IMPORTANT: Run from supergos directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"supergos:subagent-driven-development"' "$SESSION_FILE"; then
