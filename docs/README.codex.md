...
Complete guide for using Supergos with OpenAI Codex.
...
The bootstrap file is included in the repository at `.codex/supergos-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/supergos/.codex/supergos-codex find-skills to show available skills
```
...
```
Run ~/.codex/supergos/.codex/supergos-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/supergos/.codex/supergos-codex use-skill supergos:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/supergos/.codex/supergos-codex bootstrap
```
...
**Location:** `~/.codex/supergos/.codex/supergos-codex`
...
**Location:** `~/.codex/supergos/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/supergos/.codex/supergos-codex use-skill`
...
1. Verify installation: `ls ~/.codex/supergos/skills`
2. Check CLI works: `~/.codex/supergos/.codex/supergos-codex find-skills`
3. Verify skills have SKILL.md files

### CLI script not executable

```bash
chmod +x ~/.codex/supergos/.codex/supergos-codex
```
